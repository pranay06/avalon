...
class QuorumWorkerRegistryImpl(WorkerRegistryClient):
    ...
    def __validate(self, config):
        ...
        """
        if config["quorum"]["worker_registry_contract_file"] is None:
            logging.error("Missing worker registry contract file path!!")
            return False
        if config["quorum"]["worker_registry_contract_address"] is None:
    ...
    def __initialize(self, config):
        ...
        contract_file_name = tcf_home + "/" + \
            config["quorum"]["worker_registry_contract_file"]
        contract_address = \
            config["quorum"]["worker_registry_contract_address"]
