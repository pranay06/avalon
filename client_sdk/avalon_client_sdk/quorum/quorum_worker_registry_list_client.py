...
class QuorumWorkerRegistryListClientImpl(WorkerRegistryListClient):
    """
    This class is to read worker registries enttries from Quorum.
    ...
    def __validate(self, config):
        ...
        """
        if config["quorum"]["direct_registry_contract_file"] is None:
            logging.error("Missing direct registry contract file path!!")
            return False
        if config["quorum"]["direct_registry_contract_address"] is None:
    ...
    def __initialize(self, config):
        ...
        contract_file_name = tcf_home + "/" + \
            config["quorum"]["direct_registry_contract_file"]
        contract_address = \
            config["quorum"]["direct_registry_contract_address"]
