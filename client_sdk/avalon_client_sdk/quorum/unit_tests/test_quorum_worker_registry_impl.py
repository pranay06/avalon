...
from avalon_client_sdk.quorum.quorum_worker_registry_client \
     import QuorumWorkerRegistryClient
...
class TestQuorumWorkerRegistryImpl(unittest.TestCase):
    def __init__(self, config_file):
        super(TestQuorumWorkerRegistryImpl, self).__init__()
        ...
        self.__eth_conn = QuorumWorkerRegistryClient(self.__config)
...
def main():
    ...
    test = TestQuorumWorkerRegistryImpl(
        tcf_home +
