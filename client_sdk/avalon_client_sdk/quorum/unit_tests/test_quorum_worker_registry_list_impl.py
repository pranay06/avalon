...
from avalon_client_sdk.quorum.quorum_worker_registry_list_client import \
    QuorumWorkerRegistryListClient
...
class TestQuorumWorkerRegistryListImpl(unittest.TestCase):
    def __init__(self, config_file):
        super(TestQuorumWorkerRegistryListImpl, self).__init__()
        ...
        self.__eth_conn = QuorumWorkerRegistryListClient(self.__config)
...
def main():
    ...
    test = TestQuorumWorkerRegistryListImpl(
        tcf_home +
